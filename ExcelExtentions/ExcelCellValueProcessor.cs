...
namespace ExcelExtentions {
    public class ExcelCellValueProcessor {
        public static void Set(ExcelWorksheet workSheet, int row, int col, object value, ColumnValueType type, ref int magicToken) {
            ...
            switch (type) {
                ...
                case ColumnValueType.Picture:
                    setPicture(workSheet, cell, row, col, value, ref magicToken);
                    break;
        ...
        private static void setPicture(ExcelWorksheet workSheet, ExcelRange cell, int row, int col, object value, ref int magicToken) {
